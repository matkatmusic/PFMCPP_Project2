...
void variableDeclarations() {
  ...
  ignoreUnused(
      number, cash, level, point, limit, height, width, volume, density,
      pression, running, good, captain, note, room,
      side); // passing each variable declared to the ignoreUnused() function
}
